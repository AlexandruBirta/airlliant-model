...
public enum ExceptionStatus {
    ...
    TICKET_ALREADY_EXISTS("Ticket for user with id '%s' and flight id '%s' already exists for the selected seat row '%s' and seat number '%s'!", ErrorCode.TICKET_ALREADY_EXISTS, HttpStatus.BAD_REQUEST),
    ...
    TICKET_ALREADY_EXISTS_FOR_EMAIL("Ticket for user with email '%s' and flight id '%s' already exists for the selected seat row '%s' and seat number '%s'!", ErrorCode.TICKET_ALREADY_EXISTS_FOR_EMAIL, HttpStatus.BAD_REQUEST);
    ...
    @Schema(enumAsRef = true, description = "Error codes description: \n" +
            ...
            "* `TAE_014` - TICKET_ALREADY_EXISTS_FOR_EMAIL\n")
    public enum ErrorCode {
        ...
        TICKET_ALREADY_EXISTS_FOR_EMAIL("TAE_014");
